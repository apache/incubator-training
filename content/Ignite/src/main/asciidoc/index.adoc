...
Go to Ignite Projec site https://ignite.apache.org/[https://ignite.apache.org/] -> Downloads -> Binaries
Download latest binary release from the table here[https://ignite.apache.org/download.cgi#binaries]

== Java Requirements
JDK 8 and later


https://apacheignite.readme.io/docs/getting-started#section-running-ignite-with-java-9-10-11[Running using Java 9+] requires additional parameters
...
Limitation - not possible to create under transaction
...
Works under running transaction

- User has to provide configuration before startup

- Call createCache in some init method
