...
* An Apache project that isn't focused on producing software
...
[NOTE.speaker]
--
The most important point to note is that a lot of people don't realise that they can contribute, or don't know how to! 
So the first thing we focus on is getting the message out to people to let them know that all our projects and are always looking for new contributors. People to help with coding, documentation, event management, graphics, web design, training and anything else.
...
* We create tools (eg projects.a.o, people.a.o, reporter.a.o)

[NOTE.speaker]
--
Remember I said we don't focus on producing software? We don't! But that doesn't mean that we don't produce any.
...
== Newcomer resources
* Getting Started https://community.apache.org/newcomers/index.html
* FAQs https://community.apache.org/newbiefaq.html
* ASF Brochure https://cwiki.apache.org/confluence/display/COMDEV/ASF+Information+Brochure
* GSoC https://community.apache.org/gsoc.html
* Project listing https://projects.apache.org/

== Apache Local Communities

* ALC creates local groups of ASF enthusiasts
...
* Where *you* can get involved doing the things you're passionate about
