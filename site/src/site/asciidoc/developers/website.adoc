...
The website content can be found on GitHub, in the /site subdirectory, at https://github.com/apache/training[github.com/apache/incubator-training]. Within the `src/site` directory, there is a file `site.xml` which generally controls the menu and the look of the site.
